...
const loveReasons = [
    ...
    { emoji: "✨", text: "Я люблю тебя за то, как ты превращаешь самые обычные моменты в сказку." },
    { emoji: "💪", text: "Я люблю тебя за то, как ты всегда поддерживаешь меня и веришь в мои силы." },
    { emoji: "🦋", text: "Я люблю тебя за то, что при виде тебя у меня до сих пор порхают бабочки в животе." },
    { emoji: "🌟", text: "Я люблю тебя за то, как ты вдохновляешь меня становиться лучше каждый день." },
    { emoji: "🥰", text: "Я люблю тебя за твой взгляд — в нём я чувствую себя целым миром для тебя." },
    { emoji: "💕", text: "Я люблю тебя из-за того, что ты выбрала меня. Я бы выбирал тебя в каждой из жизней." },
    ...
    { emoji: "🏠", text: "Я люблю тебя за то, что любое место становится домом, когда ты рядом." },
